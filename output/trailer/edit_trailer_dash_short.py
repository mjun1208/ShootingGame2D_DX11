...
WORK=ROOT/'work-dash-short'; WORK.mkdir(exist_ok=True)
...
if __name__=='__main__':
    ...
    (ROOT/'timeline-dash-short.json').write_text(json.dumps(timeline,indent=2),encoding='utf8')
    ...
    final=ROOT/'DungeonSurvivor_Trailer_DashShort.mp4'
