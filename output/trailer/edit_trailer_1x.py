...
WORK=ROOT/'work-1x'; WORK.mkdir(exist_ok=True)
...
if __name__=='__main__':
    ...
    (ROOT/'timeline-1x.json').write_text(json.dumps(timeline,indent=2),encoding='utf8')
    ...
    final=ROOT/'DungeonSurvivor_Trailer_1x.mp4'
