...
bool Direct3D_Initialize(HWND hWnd)
{
	...
	HRESULT hr = D3D11CreateDeviceAndSwapChain(nullptr, D3D_DRIVER_TYPE_HARDWARE, nullptr, device_flags, levels,
	                                           ARRAYSIZE(levels), D3D11_SDK_VERSION, &swap_chain_desc, &g_pSwapChain,
	                                           &g_pDevice, &feature_level, &g_pDeviceContext);
	...
	if (!TimeStopEffect_Initialize(g_pDevice, g_pDeviceContext, g_pRenderTargetView, g_pDepthStencilView,
