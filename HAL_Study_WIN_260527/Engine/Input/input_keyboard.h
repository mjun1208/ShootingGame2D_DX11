...
--------------------------------------------------------------------------------
   keyboard.h をラップし、以下の入力状態を提供します。
	 ...
	 - Repeat  : 押し続けると delay_seconds 秒後から interval_seconds 秒ごとに true
==============================================================================*/
...
// キーリピート（時間指定：秒）
//   最初に delay_seconds 秒押し続けると反応し、
//   その後 interval_seconds 秒ごとに true を返す
bool InputKeyboard_IsRepeat(Keyboard_Keys key, float delay_seconds = 0.3f, float interval_seconds = 0.08f);
