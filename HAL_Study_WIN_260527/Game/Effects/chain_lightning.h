...
class cChainLightning
{
  public:
	...
	bool TryTrigger(int first_enemy_id, const DirectX::XMFLOAT2& first_hit_position, float attack_damage);
  ...
  private:
	...
	void SpawnArc(const DirectX::XMFLOAT2& start, const DirectX::XMFLOAT2& end);
